            ...
            <div>
                ...
                >
                    <button
                        ...
                        className={`z-10 w-10 h-10 sm:w-12 sm:h-12 md:w-12 md:h-12 xl:w-15 xl:h-15 bg-[#1E1E1E] rounded-full flex items-center justify-center border-[2px] overflow-hidden group cursor-pointer absolute top-[-30px] left-1/2 -translate-x-1/2`}
                    >
