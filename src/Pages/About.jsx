                ...
                <div className="max-w-[1600px] w-full bg-[#F1EAE2] mx-auto pt-16 pb-20 sm:pt-20 sm:pb-28 md:py-24 lg:py-32">
                    <div className="">
                        ...
                        <div className="flex md:flex-row flex-col items-center gap-5 md:gap-8 lg:gap-13 xl:gap-15 2xl:gap-24">
                            <div className="w-full md:w-[52.5%] overflow-hidden rounded-lg sm:rounded-xl lg:rounded-2xl relative group cursor-pointer">
                                ...
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 md:w-12 md:h-12 xl:w-15 xl:h-15 bg-white rounded-full flex items-center justify-center border-[2px] overflow-hidden">
                                    <img
                            ...
                            <div className="w-full md:w-[47.5%]">
                                ...
                                <p className="text-sm sm:text-base md:text-sm lg:text-base xl:text-lg font-PoppinsRegular mt-1 xl:mt-4">
                                    Youth is the future and every child deserves
                                    to play - and dream. This is what inspires
                                    us to do our part to shape the next
                                    generation with the fun and art of playing
                                    football.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex md:flex-row flex-col-reverse items-center gap-5 md:gap-8 lg:gap-13 xl:gap-15 2xl:gap-24 mt-12 sm:mt-16 md:mt-20 lg:mt-24 xl:mt-28">
                            <div className="w-full md:w-[47.5%]">
                                ...
                                <p className="text-sm sm:text-base md:text-sm lg:text-base xl:text-lg font-PoppinsRegular mt-1 xl:mt-4">
                                    ...
                                    colorful Future Goals are creatively made
                                    from plastic waste and fishing nets sourced
                                    from the ocean, symbolizing today’s fun and
                                    tomorrow's opportunities. By facilitating
                                    football in a sustainable way, we aim to
                                    inspire children to take care of their
                        ...
                        <div className="flex md:flex-row flex-col items-center gap-5 md:gap-8 lg:gap-13 xl:gap-15 2xl:gap-24 mt-12 sm:mt-16 md:mt-20 lg:mt-24 xl:mt-28">
                            ...
                            <div className="w-full md:w-[47.5%]">
                                ...
                                <p className="text-sm sm:text-base md:text-sm lg:text-base xl:text-lg font-PoppinsRegular mt-1 xl:mt-4">
                                    ...
                                    developing the program based on the unique
                                    scope and needs of each destination.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-[1400px] w-full bg-[#1E1E1E] mx-auto py-20 sm:py-22 md:py-26 lg:py-36">
                    <div className="flex flex-col justify-center text-center">
                        ...
                        <p className="text-[15px] sm:text-[17px] text-[#F1EAE2] font-PoppinsRegular  leading-[25px] sm:leading-[27px] max-w-[600px] w-full mx-auto">
                            Future Goals wouldn’t be possible without the help
