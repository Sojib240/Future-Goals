                ...
                <PageAnimation>
                    <div key={id}>
                        ...
                        <div className="w-full bg-[#1E1E1E] sm:px-5 md:px-8 lg:px-10 xl:px-10 relative">
                            <div className="max-w-[1440px] w-full bg-[#F1EAE2] rounded-3xl mx-auto px-6 sm:px-10 md:px-18 lg:px-24 xl:px-32 py-16 sm:py-20 md:py-24 lg:py-32 text-[15px] sm:text-[17px] text-[#1E1E1E] font-PoppinsRegular  leading-[25px] sm:leading-[27px] -translate-y-0 sm:-translate-y-[100px] relative z-50">
                                <div className="flex justify-center items-center gap-[1vw] w-full absolute top-[-1.55vw] left-1/2 -translate-x-1/2 z-50">
                                    <button
                                        onClick={() => getPrev()}
                                        className={`z-10 w-10 h-10 sm:w-12 sm:h-12 md:w-12 md:h-12 xl:w-15 xl:h-15 bg-white rounded-full flex items-center justify-center border-[2px] overflow-hidden group cursor-pointer relative ${
                                            currentIndex == 0
                                                ? "hidden"
                                                : "block"
                                        }`}
