    ...
    return (
        <div>
            <CommonHero2
                ...
                sizes={"text-[7.8vw] leading-[7.8vw] sm:text-[6.8vw] md:text-[5.8vw] lg:text-[5.8vw] xl:text-[4.8vw] sm:leading-[6.8vw] md:leading-[5.8vw] lg:leading-[5.8vw] xl:leading-[4.8vw]"}
                logo={null}
                paddings={'pb-38 sm:pb-38 md:pb-40 lg:pb-48 xl:pb-54 2xl:pb-64 pt-50 sm:pt-54 md:pt-60 lg:pt-64 xl:pt-72 2xl:pt-80'}
            />
                        ...
                        {news.map(
                            ({
                                ...
                                return (
                                    ...
                                    >
                                        <div className="img overflow-hidden rounded-2xl aspect-[3/2] w-full sm:w-[47%] lg:w-auto">
                                            <img
                                        ...
                                        <div className="flex flex-col justify-between flex-1 pt-5 sm:pt-0 lg:pt-6">
                                            {/* Top Section */}
                                            <div>
                                            ...
                                            <div className="mt-auto">
                                                ...
                                                <button className="border-[2px] lg:border-0 rounded-lg py-3 px-6 font-BriceSemiBold text-sm xl:text-lg uppercase bg-[#1E1E1E] lg:bg-[#FCFCFC] text-[#FCFCFC] lg:text-[#1E1E1E] border-[#1E1E1E] relative overflow-hidden cursor-pointer w-full">
