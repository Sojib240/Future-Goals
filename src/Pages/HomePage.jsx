        ...
        <PageAnimation>
            <div className="">
                ...
                <div className="px-5 md:px-8 lg:px-10 xl:px-10 bg-[#F1EAE2]">
                    <div className="max-w-[1600px] w-full mx-auto bg-red-200 rounded-3xl overflow-hidden relative -translate-y-[60px] sm:-translate-y-[80px] z-30">
                        <div className="p-5 md:p-10 lg:p-14 xl:p-16 2xl:p-24 flex items-center flex-col lg:flex-row gap-5 lg:gap-10 xl:gap-16 2xl:gap-24 relative z-10">
                            <div className="w-full lg:w-[55%] overflow-hidden rounded-lg sm:rounded-xl lg:rounded-2xl relative group cursor-pointer">
                            ...
                            <div className="w-full lg:w-[45%] text-white">
                                ...
                                <Link
                                    to={"/about/"}
                                    className="group border-[2px] rounded-lg py-3 px-6 font-BriceSemiBold text-sm xl:text-lg uppercase bg-white text-[#1E1E1E] border-[#1E1E1E] relative overflow-hidden cursor-pointer w-full sm:w-auto inline-block"
                                >
